...
function renderGreenPeppers() {
  ...
  document.querySelectorAll('.green-pepper').forEach((greenPeppersOne) => {
    if (state.greenPeppers) {
      greenPeppersOne.style.visibility = 'visible';
    } else {
      greenPeppersOne.style.visibility = 'hidden';
    }
  });
}
...
function renderPrice() {
  ...
  for (let ingredient in state) {
    if (state[ingredient]) {
      ...
      priceTotal += ingredients[ingredient].price;
    }
  }
